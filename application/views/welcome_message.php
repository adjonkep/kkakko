...
<html lang="en">
  ...
  <body>
    ...
    <div class="welcome-div">
      <h3>Bienvenue sur <span class="text-warning"><img alt="KkakKo Logo" class="img-responsive" src="<?php echo base_url(); ?>assets/images/kkakko.png"/></span> ,Votre nouvelle </br>fa&ccedil;on d&#39;exp&eacute;dier courriers et petits colis &agrave; travers le </br>monde.</h3>
    </div>
    <div>
